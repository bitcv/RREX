        ...
        (i.prototype.show = function() {
          ...
          d("GUI", "Objects Tree"),
            ...
            e.enabled("support_manage_drawings") &&
              ((_ = $("<div>")),
              (m = $("<div>")),
              (u = new a(l, this._chartWidget, this._model, m, _)),
              (o = o.add(_)),
              t.push({
                customControl: _,
      ...
      o(508),
        ...
        (s.prototype.createTreeNodeItem = function(t, e, o) {
          ...
          return (
            ...
            r.click(this._onNodeToggleExpandCollapse.bind(this, r, t)),
            (s = r
              .find(".js-remove-btn")
            ...
            s.click(
              function(e) {
                e.preventDefault(),
                  this._nodeRemoveCallback && this._nodeRemoveCallback(r, t);
              }.bind(this)
            ),
            r
          );
        ...
        (s.prototype.createItem = function(t, e) {
          ...
          return (
            ...
            s.userEditEnabled() &&
              (e.lockUnlock &&
                this._setupLockUnlockButton(o.find(".js-lock-unlock-btn"), s),
              e.showHide &&
              ...
              this._setupFormatButton(o.find(".js-format-btn"), s),
              this._canShowEditObjectDialog(s) &&
                (o.dblclick(this._showEditObjectDialog.bind(this, s)),
                e.addContextMenu &&
                  o.on(
                    "contextmenu",
                    function(t) {
              ...
              this._setupItemRemoveButton(o.find(".js-remove-btn"), s)),
            o
          );
        }),
        ...
        (s.prototype._canShowEditObjectDialog = function(t) {
          return (
            ...
            ((t !== this._chartModel.mainSeries() ||
              ...
              (m.hasStylesPropertyPage(t) || m.hasInputsPropertyPage(t)))
          );
        }),
        ...
        (s.prototype._setupFormatButton = function(t, e) {
          ...
          t.attr("title", $.t("Format")).click(
            this._showEditObjectDialog.bind(this, e)
          );
        }),
        ...
        (s.prototype._setupItemPropertyButton = function(t, e, o, i, s, r) {
    ...
    o(510),
        ...
        for (
          ...
          if (((o = t[e]), o.children.length))
            for (i = o.children.length - 1; i >= 0; --i)
              (s = o.children[i]),
                (r = this._getItemForSourceId(s.datasource.id())),
                0 !== r.length && this._listAccessor().updateItem(r, s);
      }),
      ...
      (i.prototype._renderViewInternal = function(t) {
        var e,
          ...
          i,
          s,
          r = "studies" !== this._filter.value() && this._items.drawings.length;
        for (
